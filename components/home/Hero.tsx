...
export function Hero() {
  ...
  return (
    <section className="relative pt-44 sm:pt-40 lg:pt-36 pb-14 px-3 sm:px-6 lg:px-8 overflow-hidden min-h-[calc(100vh-1rem)] lg:min-h-dvh flex items-start sm:items-center bg-gradient-to-b from-[#fcfbf9] via-[#f8f5ee] to-[#f0eae0]">
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-14 items-start">
          ...
          <div className="order-1 lg:order-1 space-y-6 lg:space-y-10 pt-2 sm:pt-3">
            <motion.div
